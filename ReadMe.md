...
## License
Mimo's source code is licensed under the [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://raw.githubusercontent.com/JeremyTCD/JeremyTCD.github.io/dev/License.txt).  

Mimo's binaries are licensed under the [![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/).
Kindly keep the attribution notice ("Site generated by DocFX Theme by JeremyTCD") in the footer.  

The Mimo logo and the red J logo used in the examples are copyright of JeremyTCD and used by permission for this project only. 
